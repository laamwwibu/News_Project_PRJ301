 ...
 * @author VICTUS
 */
@WebServlet(name = "homePageLoad", urlPatterns = {"/home"})
public class homePageLoad extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Category> categories_list = categoryDAO.getAllCategories();
        request.setAttribute("categories_list", categories_list);
